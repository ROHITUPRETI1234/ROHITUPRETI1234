<!---Banner-->
![RU](https://github.com/user-attachments/assets/5f2b1374-0b95-4218-bd9d-0b6f3fa9a2be)
...
<!-- <table >
  <tr>
    ...
    <p>➡️Full-stack web development (React, Express, MongoDB, MySQL and SpringBoot) and learning DevOps (Docker, Kubernetes, Jenkins) for deployment & automation.</p>
    <strong>💬 Ask me about</strong><br>
    <p>➡️My experience with the MERN stack and Spring Boot includes building scalable full-stack applications using MongoDB, Express, React, Node.js, and Spring Boot.</p>
    ...
    <p>➡️How I am learning Kubernetes and Jenkins to streamline application deployment and automate CI/CD workflows.</p>
      ...
      ➡️I have a knack for simplifying challenging algorithms and enjoy building tools bridging the design and functionality gap.
<!--     </td>
  </tr>
</table> -->
